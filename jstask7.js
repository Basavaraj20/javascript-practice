...
// reduce()
let cart = [
    { product: "jacket", price: 2000, qty: 2 },
    { product: "smart Watch", price: 1500, qty: 1 },
...
let employees = [
    ...
    { name: "basavaraj", salary: 50000 },
    { name: "kiran", salary: 45000 },
    { name: "amar", salary: 30000 }
]
...
// find()
let hotels = [
    { hotel: "sptagiri", rating: 4.1 },
    { hotel: "KFC", rating: 4.7 },
    { hotel: "inox", rating: 4.3 }
]
...
let restaurants = [
    ...
    { name: "special food", rating: 2.8 },
    { name: "king restaurants", rating: 4.5 }
];

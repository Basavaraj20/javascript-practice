...
let h = apiData.then(product => {
    let ele = "electronics";
    let iteams = product.filter((c,i,t)=>c.category.includes(ele))
    console.log("Electronic Count :",iteams.length);
...
// Task 13: Calculate Averge product Price
